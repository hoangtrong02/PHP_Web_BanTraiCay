    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <nav class="header__menu">
                    <ul>
                        <li class=""><a href="./quanlysanpham.php">Quản lý sản phẩm</a></li>
                        <li class="active"><a href="./quanlydonhang.php">Đơn hàng</a></li>
                    </ul>
                </nav>
            </div>
        </div>
        <table class="table">
            ...
            <tbody>
                ...
                on order_detail.proid = products.proid group by orders.orderid");
                ...
                ?>
                    <tr class="table-success">
                        ...
                        <td style="text-align: center;">0<?= number_format($order['phone'], 0, ".", ".")?></td>
                        <td style="text-align: center;"><?=date("H:i d/m/Y", $order['created_time'])?></td>
                        <td style="text-align: center;"><a href="./chitietdonhang.php?orderid=<?=$order['orderid']?>" class="">Chi tiết</a>&nbsp;&nbsp;
